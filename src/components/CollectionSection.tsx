...
const CollectionSection = () => {
  ...
  return (
    <section id="collections" className="py-[120px] px-6 md:px-16 max-w-[1280px] mx-auto">
      <div className="text-center mb-16">
        <span className="text-[11px] uppercase tracking-[0.15em] font-semibold text-brand-gold mb-3 block">
          House Selections
        </span>
        <h2 className="font-serif text-5xl md:text-[64px] gold-text leading-[1.1] tracking-[-0.02em]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {featured.map((fabric, idx) => (
          ...
          >
            <div className="aspect-[4/5] overflow-hidden bg-brand-surface mb-5">
              <FabricImage
                photo={fabric.photo}
            ...
            <h3 className="font-serif text-2xl text-brand-ink leading-tight mb-1">{fabric.name}</h3>
            <p className="text-[11px] uppercase tracking-[0.1em] font-semibold text-brand-ink-soft mb-2">
              {fabric.category}
            </p>
