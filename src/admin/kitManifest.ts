...
export const KIT_SECTIONS: KitSection[] = [
  {
    ...
    assets: [
      ...
      {
        id: 'master-trim',
        name: 'Master logo — trimmed',
        description: 'Tightly-cropped, transparent-background version of the master. This is what the kit generator pastes into social, print, and OG assets.',
        url: `${ROOT}/master-logo-trim.png`,
        size: '658 × 771',
        aspect: 'tall',
        framing: 'contain',
        kind: 'png',
      ...
      {
        id: 'mark-master',
        name: 'Mark only (painted)',
        description: 'Just the TC monogram with figure — wordmark stripped. Used for favicons ≥128 px and any context where a compact brand mark is needed.',
        url: `${ROOT}/mark-master.png`,
        size: '583 × 604',
        aspect: 'square',
        framing: 'contain',
        kind: 'png',
